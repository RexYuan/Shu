...
%TODO: explain various measures have different origins. for presentation we assume Y=1 to be detrimental. use comaps as example and the intuition is Y=1 => reoffend; but if the case is school or loan the tuition is reversed
...
%TODO: rewrite, move compas example to positive balance
...
%TODO: rewrite use footnote to explain name origin
...
%TODO: rewrite, set positive = detrimental to all cases
...
%TODO: move this to the back and choose one measure to comapre with compas
