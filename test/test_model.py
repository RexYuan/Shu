...
c.equal_calibration(0.2, trained_tree, lambda row: row['race'] != race, lambda u,l: (lambda Y: l <= int(Y) and int(Y) <= u), (7, 5), lambda row: row['is_recid'] == '1')
...
c.nagative_balance(5, trained_tree, lambda row: row['race'] != race, lambda Y: int(Y), lambda row: row['is_recid'] == '1')
